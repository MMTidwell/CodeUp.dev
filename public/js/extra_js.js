(function() {
    ...
    console.log(student.name + " made the following avg grade in HTML: " + (total / htmlGrades.length) + "!")

    function getAvgGrade(arrayOfNumbers) {
        var numberOfGrades = arrayOfNumbers.length;
        var total = 0;
        var average;

        arrayOfNumbers.forEach(function(grades){
            total += average;
        });
        average = total / numberOfGrades;
        return average
    }
    console.log(student.name + " made the following avg grade in HTML: " + getAvgGrade(htmlGrades) + "!")
})();
